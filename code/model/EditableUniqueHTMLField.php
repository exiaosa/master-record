...
class EditableUniqueHTMLField extends EditableFormField {

    private static $singular_name = 'Form Terms';

    private static $plural_name = 'Form Terms';
    ...
    public function getCMSFields() {
        ...
        $fields->removeByName(array('Default', 'Validation', 'RightTitle','MergeField','Title'));

        $fields->addFieldsToTab('Root.Main', array(
            HTMLEditorField::create('Content', _t('EditableLiteralField.CONTENT', 'Content'))
                ->setRows(4)
                ->setColumns(20)
    ...
    public function onBeforeWrite()
    {
        ...
        $this->Content = MasterRecordConfig::current_config()->dbObject('Terms')->forTemplate();
    }
    ...
    public function getFormField() {
        ...
        $field = new LiteralField(
            ...
            sprintf(
                ...
                $label,
                MasterRecordConfig::current_config()->dbObject('Terms')->forTemplate()
            )
        );
